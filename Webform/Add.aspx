<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="QLSP_NoSeparateForm.Webform.Add" %>
<!DOCTYPE html>
        ...
        <div class="form-container">
            <table>
                <tr>
                    ...
                    <td><asp:TextBox ID="txt_masp" runat="server" /></td>
                </tr>
                <tr>
            ...
            <asp:Button ID="btn_nhaplai" runat="server" Text="Nhập lại" OnClick="btn_nhaplai_Click" />
            <asp:Button ID="btn_quaylai" runat="server" Text="Quay lại" PostBackUrl="~/Webform/Sanpham.aspx" />
        </div>
    </form>        
    <script>
