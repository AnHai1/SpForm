<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="QLSP_NoSeparateForm.Webform.Edit" %>
<!DOCTYPE html>
        ...
        <div class="form-container">
            <table>
                <tr>
                    ...
                    <td><asp:TextBox ID="txt_masp" runat="server" Enabled="false" /></td>
                </tr>
                <tr>
                    <td><label for="txt_tensp">Tên sản phẩm:</label></td>
                    <td><asp:TextBox ID="txt_tensp" runat="server" /></td>
                </tr>
                <tr>
                    <td><label for="txt_hangsx">Hãng sản xuất:</label></td>
                    <td><asp:TextBox ID="txt_hangsx" runat="server" /></td>
                </tr>
                <tr>
                    <td><label for="txt_mota">Mô tả:</label></td>
                    <td><asp:TextBox ID="txt_mota" runat="server" TextMode="MultiLine" /></td>
                </tr>
                <tr>
                    <td><label for="txt_dongia">Đơn giá:</label></td>
                    <td><asp:TextBox ID="txt_dongia" runat="server" /></td>
                </tr>
                <tr>
                    <td><label for="FileUpload1">Hình ảnh:</label></td>
                    <td>
                        <asp:Image ID="imgCurrent" runat="server" Width="100" Height="100" />
                        <asp:FileUpload ID="FileUpload1" runat="server" />
                    </td>
                </tr>
            </table>
            <asp:Button ID="btn_CapNhat" runat="server" Text="Cập nhật" OnClick="btn_CapNhat_Click" />
            <asp:Button ID="btn_Huy" runat="server" Text="Hủy" PostBackUrl="~/Webform/Sanpham.aspx" />
        </div>
    </form>
    <script>
