<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="QLSP_NoSeparateForm.Webform.Search" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server">
        <div class="search-container">
            <div class="search-fields">
                <asp:TextBox ID="txtSearch" runat="server" placeholder="Nhập tên sản phẩm..."></asp:TextBox>
                <asp:DropDownList ID="ddlHangsx" runat="server">
                    <asp:ListItem Text="Tất cả hãng" Value="" />
                </asp:DropDownList>
            ...
            <div class="gridview-container">
                <asp:GridView ID="gvSearchResults" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="Masp" CellPadding="10" OnRowCommand="gvSearchResults_RowCommand">
                    <Columns>
